 ...
 */
final class Version20210922150711 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993984236B22C FOREIGN KEY (delivery_space_id) REFERENCES delivery_space (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
