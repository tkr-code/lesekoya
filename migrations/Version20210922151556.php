 ...
 */
final class Version20210922151556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_F52993984236B22C ON `order` (delivery_space_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F52993984236B22C ON `order`');
