...
class DeliverySpaceController extends AbstractController
{
    ...
    {
        return $this->render('client/delivery_space/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->renderForm('client/delivery_space/new.html.twig', [
    ...
    {
        return $this->render('client/delivery_space/show.html.twig', [
            'delivery_space' => $deliverySpace,
        ]);
    }
    ...
    public function edit(Request $request, DeliverySpace $deliverySpace): Response
    {
        ...
        return $this->renderForm('client/delivery_space/edit.html.twig', [
            'delivery_space' => $deliverySpace,
            'form' => $form,
        ]);
    }
